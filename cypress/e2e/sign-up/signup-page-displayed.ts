import {
    FIRST_LAST_NAME_HDR, EMAIL_HDR, MOBILE_NUMBER_HDR, BUSINESS_NAME_HDR, EMPLOYEE_DROPDOWN_HDR, 
    PASSWORD_HDR, LETSGO_BTN, 
  ...
  describe('Verify Signup Page is loaded', () => {
    it('Visits the staging workyard website Signup Page', () => {
      ...
      cy.contains('a', 'Terms of Use').should('be.visible').and('have.attr', 'href', "https://workyard.com/app/terms?c=us");
      cy.contains('a', 'Privacy Policy').should('be.visible').and('have.attr', 'href', "https://workyard.com/app/privacy?c=us");
    })
  })
