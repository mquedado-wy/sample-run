//SIGN-UP INLINE ERROR MESSAGES
    export const FIRST_LAST_NAME_ERROR_MSG1 = 'Please enter your first and last name.';
    ...
    export const MOBILE_NUMBER_ERROR_MSG2 = 'Phone number is not valid. Include +CountryDialingCode for non-US numbers.';
    ...
    export const PASSWORD_ERROR_MSG2 = 'Please choose a valid password that contains at least 8 characters and one numeric value.';
...
//SIGN-UP URLS
    export const WYSTAGING_SIGNUP_URL = 'https://www.stagingworkyardwebsite.com/u/sign_up';

//SIGN-UP CONSTANT VARIABLES
    export const INIT_NAME = 'WY User';
    export const DYNAMIC_EMAIL = `mark.quedado+test${Math.floor(Math.random() *9000)+1000}@workyard.com`;
    export const DYNAMIC_MOBILE_NUMBER = `+1${Math.floor(Math.random() * 9000000000) + 1000000000}`;
    export const DYNAMIC_BUSINESS_NAME = `WY Inc V${Math.floor(Math.random() *900)+100}`;
