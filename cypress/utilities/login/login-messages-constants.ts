...
export const NEW_SIGNUP_EMAIL_1 = `new.user1.${Math.floor(Math.random() * 900) + 100}${Cypress.env('STAGING_APP_ENV')}@workyard.testinator.com`
export const NEW_SIGNUP_EMAIL_2 = `new.user2.${Math.floor(Math.random() * 900) + 100}${Cypress.env('STAGING_APP_ENV')}@workyard.testinator.com`
